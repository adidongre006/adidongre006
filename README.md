...
<img src="https://img.shields.io/badge/Multi--Agent%20Systems-0075FF?style=for-the-badge&logo=agent&logoColor=white" />
...
<a href="https://github.com/adidongre006?tab=stars"><img src="https://github-readme-streak-stats.herokuapp.com?user=adidongre006&theme=gotham&hide_border=true&date_format=M%20j%5B%2C%20Y%5D" height="30%" width="50%" alt="@adidongre006's github-readme-streak-stats" /></a>
...
> *Swap these in with your own repos — pin the ones that best show off your RAG / agent / ML deployment work.*

| Project | Description | Stack |
|---|---|---|
| 🔗 [Project Name](https://github.com/adidongre006) | RAG-based assistant that retrieves and answers over a custom knowledge base | `LangChain` `ChromaDB` `FastAPI` |
| 🔗 [Project Name](https://github.com/adidongre006) | Multi-agent workflow orchestrating specialized agents with LangGraph | `LangGraph` `Python` `Docker` |
| 🔗 [Project Name](https://github.com/adidongre006) | End-to-end ML model trained, containerized, and deployed to production | `scikit-learn` `Docker` `Railway` | -->
...
- Snake contribution animation (needs a GitHub Action to generate the SVG):
  <img src="https://raw.githubusercontent.com/adidongre006/adidongre006/output/snake.svg" alt="Snake animation" />
- Pacman contribution graph (same requirement):
  <picture>
